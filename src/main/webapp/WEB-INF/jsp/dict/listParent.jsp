      ...
      <form class="layui-form layui-form-pane search-form" action="${path}/dict/list.do">
        <div class="layui-form-item">
          ...
          <div class="layui-input-inline">
            <input type="text" style="display: inline-block;" name="dict_name" id="dict_name" value="${dict_name}" placeholder="请输入名称搜索" autocomplete="off" class="layui-input">
          </div>
  ...
  laypage({
    ...
    ,jump: function(e, first){ //触发分页后的回调
      if(!first){ //一定要加此判断，否则初始时会无限刷新
        ...
        location.href = '${path}/dict/listParent.do?page='+e.curr;
      }
    }
  });
})
