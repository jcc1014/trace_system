      ...
      <div class="layui-main">
        ...
        <ul class="layui-nav top-nav-container">
          ...
          <li class="layui-nav-item">
            <a href="javascript:void(0)">运输管理</a>
          </li>
          <!-- <li class="layui-nav-item">
        ...
        <div class="top_admin_user">
        	<span>当前用户：${sessionScope.user.username }（运输员）&nbsp;&nbsp;&nbsp;|</span>
    ...
    <div class="layui-side layui-bg-black">
        <div class="layui-side-scroll">
			...
			<ul class="layui-nav layui-nav-tree left_menu_ul hide">
					<li class="layui-nav-item layui-nav-title"><a href="#">检验管理</a></li>
					<li class="layui-nav-item first-item">
						<a href="${path}/sampling/testList.do" target="main"> <i
							class="layui-icon">&#xe613;</i> <cite>检验列表</cite>
						</a>
					</li>
					<li class="layui-nav-item">
						<a href="${path}/sampling/hadTestList.do" target="main"> <i
							class="layui-icon">&#xe613;</i> <cite>已检验列表</cite>
						</a>
					</li>
			</ul>	
        </div>
