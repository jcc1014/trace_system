...
<div id="containers">
	<div class="address_main">
		<div class="line"><input placeholder="请输入新密码" id="new_password"/></div>
		<div class="line"><input placeholder="再次输入新密码" id="new_password_again"/></div>
	</div>
</div>
...
<script type="text/javascript">
    ...
    function save() {
        ...
        if (new_password == null || new_password.trim() == "" || new_password_again == null || new_password_again.trim() == "") {
            layer.msg("请完成密码输入");
            return;
        }
        ...
        $.ajax({
            url: '${path}/mall/personal_setting_password_save.do',
            type: 'post',
            data: {newPassword: new_password, key: md5Key},
            success: function (res) {
                res = JSON.parse(res);
                if (res.code == 200) {
                    layer.msg("保存" + res.msg + "，请重新登录", {time:1500}, function () {
