    ...
    <article style="padding-bottom: 54px;padding-top:44px;">
        <div class="list-wrap">
            ...
            <ul class="app-list">
                <li>
                    <div class="app-wrap">
                        <a href="${path}/purchaseInfo/todayCgd.do">
                ...
                <li>
                    <div class="app-wrap">
                        <a href="${path}/purchaseInfo/allQhcgd.do">
                ...
                <li>
                    <div class="app-wrap">
                        <a href="${path}/purchaseInfo/history.do">
                ...
                <li>
                    <div class="app-wrap">
                        <a href="${path}/purchaseInfo/allQhd.do">
                            <img src="${path}/images/orderModule/quehuo.png" class="iconfont"/>
                            <span>缺货单</span>
                        </a>
                    </div>
                ...
                <li>
                    <div class="app-wrap">
                        <a href="${path}/purchaseInfo/getFyd.do">
